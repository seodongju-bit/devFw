...
<aside class="well span3 oc" id="a" role="navigation" style="margin-top: 110px;">
      <ul class="nav nav-list">
        ...
        <li align=left><a href="myPage.do"><img src="../devFw/resources/image/icon/cancle.png"  alt="내역" style="width:30px;">&nbsp;&nbsp;&nbsp;주문목록/배송조회</a></li>
        <li><a href="#"><img src="../devFw/resources/image/icon/delivery.png"  alt="배송" style="width:30px;">&nbsp;&nbsp;&nbsp;배송관리</a></li>
        <li class="nav-header">My 혜택</li>
         <li><a href="givecoupon.do"><img src="../devFw/resources/image/icon/down.png"  alt="다운" style="width:30px;">&nbsp;&nbsp;&nbsp;쿠폰 받기</a></li>
